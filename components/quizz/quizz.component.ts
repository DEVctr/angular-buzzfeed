...
export class QuizzComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (quizz_questions) {
      ...
      this,this.questionsSelected = this.questions[this.questionIndex]
  ...
  async nextStep() {
    ...
    this.porcentagem = this.updatePorcentagem();
  }
  ...
  updatePorcentagem(): number {
    return (this.questionIndex / this.questionMaxIndex) * 100 ;
  }
}
